<div class="list-group">
    @if(Request::is('admin*'))
        ...
        <a href="{{ route('admin.createPost') }}" class="{{ Request::is('admin/create-post') ? 'active' : '' }} list-group-item list-group-item-action list-group-item-success link">Create Post</a>
        ...
        <a href="{{ route('admin.blogPosts') }}" class="{{ Request::is('admin/view-post') ? 'active' : '' }} list-group-item list-group-item-action list-group-item-success link">View Posts</a>
