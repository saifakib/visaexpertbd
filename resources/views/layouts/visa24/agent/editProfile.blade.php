                                ...
                                <form method="POST" action="{{ route('updateProfile') }}" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8">
                                                <input type="text" name="agent_name" value="{{ $user->agent->agent_name }}" class="form-control col-md-8 text-left" id="agent_name">
                                            </div>
                                        </div>
                                        <div class="clearfix"></div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8">
                                                <input type="text" name="title" value="{{ $user->agentDetails->title }}" class="form-control col-md-8 text-left" id="title">
                                            </div>
                                        </div>
                                        <div class="clearfix"></div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8">
                                                <textarea name="details" id="details" value="{{ $user->agentDetails->details }}" class="form-control col-md-8 text-left" cols="30" rows="05"></textarea>
                                            </div>
                                        </div>
                                        <div class="clearfix"></div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8">
                                                <input type="text" name="license" value="{{ $user->agentDetails->license }}" class="form-control col-md-8 text-left" id="license">
                                            </div>
                                        </div>
                                        <div class="clearfix"></div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8">
                                                <input type="text" name="location" value="{{ $user->agentDetails->location }}" class="form-control col-md-8 text-left" id="location">
                                            </div>
                                        </div>
                                        <div class="clearfix"></div>
